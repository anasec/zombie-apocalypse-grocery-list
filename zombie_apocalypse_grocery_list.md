...
- [ ] Bottled water (1–2 gallons per person per day, minimum 14 days)
- [ ] Collapsible or hard water containers (5–10 liters)
- [ ] Portable filter (Sawyer Mini, Lifestraw, or similar)
- [ ] Water purification tablets
- [ ] Unscented bleach for emergency disinfection
- [ ] Metal pot for boiling water

---

## 2. Food (Long Shelf Life, High Calorie)
- [ ] White rice
...
- [ ] Allergy medication
- [ ] Prescription meds (30–60 day supply)
- [ ] Tourniquet
- [ ] Trauma shears
- [ ] Emergency blankets
- [ ] Burn cream
...
- [ ] Cookware (metal pot, pan, utensils)
...
- [ ] Disinfecting wipes
- [ ] Bleach
- [ ] Buckets for sanitation
- [ ] Portable toilet liners or bags
...
## 12. Long-Term Preparedness (Optional)
- [ ] Seeds (heirloom)
- [ ] Fishing line and hooks
- [ ] Grain grinder
- [ ] Additional boots
- [ ] Secondary shelter (tent)
